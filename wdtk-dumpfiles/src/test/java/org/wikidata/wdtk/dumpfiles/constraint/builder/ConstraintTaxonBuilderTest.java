...
/**
 * Test class for {@link ConstraintTaxonBuilder}
 * 
 * @author Julian Mendez
 * 
 */
public class ConstraintTaxonBuilderTest {

	@Test
	public void testBuilder() {

		ConstraintTaxonBuilder builder = new ConstraintTaxonBuilder();
		TemplateParser parser = new TemplateParser();
		Template template = parser.parse("{{Constraint:Taxon}}");
		PropertyIdValue constrainedProperty = ConstraintTestHelper
				.getPropertyIdValue("P105");
		ConstraintTaxon expectedConstraint = new ConstraintTaxon(
				constrainedProperty);
		ConstraintTaxon constraint = builder.parse(constrainedProperty,
				template);
