 ...
 * 
 */
public class ConstraintQualifierBuilderTest {

	public ConstraintQualifierBuilderTest() {
	}

	@Test
	public void testBuilder() {

		ConstraintQualifierBuilder builder = new ConstraintQualifierBuilder();
		TemplateParser parser = new TemplateParser();
		Template template = parser.parse("{{Constraint:Qualifier}}");
		PropertyIdValue constrainedProperty = ConstraintTestHelper
				.getPropertyIdValue("P1011");
		ConstraintQualifier expectedConstraint = new ConstraintQualifier(
				constrainedProperty);
		ConstraintQualifier constraint = builder.parse(constrainedProperty,
				template);
