...
/**
 * Test class for {@link ConstraintOneOf} of a single string.
 *
 * @author Julian Mendez
 *
 */
public class ConstraintOneOfStringSingleRendererTest implements
		ConstraintRendererTestInterface {

	public static final String TEMPLATE_STR_STRING_SINGLE_VAL = "{{Constraint:One of|values=m}}";

	ConstraintRendererTestHelper testHelper = new ConstraintRendererTestHelper(
			"oneofstringsingle");

	public ConstraintOneOfStringSingleRendererTest() {
	}

	@Override
	public Constraint getConstraint() {
		return this.testHelper.getConstraint("P1632",
				TEMPLATE_STR_STRING_SINGLE_VAL);
	}
	...
	public void testRenderConstraint() throws IOException {
		...
		renderer.renderStrings(null, null);
