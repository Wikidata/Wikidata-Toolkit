...
/**
 * Test class for {@link ConstraintOneOf} of strings.
 *
 * @author Julian Mendez
 *
 */
public class ConstraintOneOfStringRendererTest implements
		ConstraintRendererTestInterface {

	ConstraintRendererTestHelper testHelper = new ConstraintRendererTestHelper(
			"oneofstring");

	public ConstraintOneOfStringRendererTest() {
	}

	@Override
	public Constraint getConstraint() {
		return this.testHelper.getConstraint("P1632",
				ConstraintOneOfTest.TEMPLATE_STR_STRING_VAL);
	}
