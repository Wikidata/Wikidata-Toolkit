...
/**
 * Test class for {@link ConstraintFormatBuilder}.
 * 
...
public class ConstraintFormatBuilderTest {
	...
	public void testBuilder() {
		...
		ConstraintFormatBuilder builder = new ConstraintFormatBuilder();
		PropertyIdValue constrainedProperty = ConstraintTestHelper
				.getPropertyIdValue(propertyName);
		ConstraintFormat expectedConstraint = new ConstraintFormat(
				constrainedProperty, pattern);
		ConstraintFormat constraint = builder.parse(constrainedProperty,
				template);
