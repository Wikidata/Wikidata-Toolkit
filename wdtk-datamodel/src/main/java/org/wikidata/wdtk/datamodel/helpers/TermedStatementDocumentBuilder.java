 ...
 */
public abstract class TermedStatementDocumentBuilder<T extends TermedStatementDocumentBuilder<T, O>, O extends StatementDocument & TermedDocument>
		extends EntityDocumentBuilder<T, O> {
	 ...
	 */
	protected TermedStatementDocumentBuilder(EntityIdValue entityIdValue) {
		super(entityIdValue);
	}
	 ...
	 */
	protected TermedStatementDocumentBuilder(O initialDocument) {
